...
//    Convert a Runtime Value to Compile-Time - Less Repetitive
...
void main(string[] args)
{
	...
	{
		writeln("Usage:");
		writeln("  ex6_meta_flex3_runtimeToCompileTime2 "~
			"{bigPort} {extrasNumPorts} {extrasIsSpinnable}");
		writeln("bigPort must be 3, 5 or 10");
		writeln("Example: ex6_meta_flex3_runtimeToCompileTime2 5 2 true");
		return;
	}
